...
%
      ...
      \begin{frame}
        ...
        \begin{enumerate}
        \vfill \item Could you think of a way to extend binary logistic
          regression for multinomial classification problems?

          
        \vfill \item Could you prove that the logistic function's log-loss is
          a convex function?

          
        \vfill \item What if we use other sigmoid functions (e.g. scaled
